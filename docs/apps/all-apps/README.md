...
If we don't have an integration for an app that you'd like to see, please [request it on our Github roadmap](https://github.com/PipedreamHQ/pipedream/issues/new?assignees=&labels=app&template=app---service-integration.md&title=%5BAPP%5D) or [reach out to our team](/support).
...
- [Shopify (read all orders)](https://www.shopify.com/)
